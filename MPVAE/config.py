...
tf.app.flags.DEFINE_string('checkpoint_path', './model/lr-0.001_lr-decay_0.50_lr-times_3.0_nll-0.10_l2-1.00_c-200.00/model-76','The path to a checkpoint from which to fine-tune.')

# tf.app.flags.DEFINE_string('data_dir', './data/bibtext/bibtext_data.npy','The path of input observation data')
# tf.app.flags.DEFINE_string('train_idx', './data/bibtext/bibtext_train_idx.npy','The path of training data index')
# tf.app.flags.DEFINE_string('valid_idx', './data/bibtext/bibtext_val_idx.npy','The path of validation data index')
# tf.app.flags.DEFINE_string('test_idx', './data/bibtext/bibtext_test_idx.npy','The path of testing data index')
...
tf.app.flags.DEFINE_integer('max_epoch', 1, 'max epoch to train')
