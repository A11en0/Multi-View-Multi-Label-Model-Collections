function [Pre_Labels,Outputs] = GRADIS(MV_train_data,train_target,MV_test_data, test_target, threshold, rate, K, alpha)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    model = MVPL(mv_train_data,train_target',K, alpha);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    parfor i=1:label_num
        if sum(final_target(:,i))~=0
            ...
            clf = svmtrain(double(final_target(:,i)),double(temp(1:train_data_num,:)),'-t 0 -b 1 -q');
            [predicted_label,accuracy,prob_estimates]=svmpredict(double(test_target(:,i)), double(temp(train_data_num+1:train_data_num+test_data_num,:)),clf,'-b 1');
